...
public class Solution extends HashMap<VM, LinkedList<Allocation>>{
	...
	public Solution(Solution nsolution) {
		// TODO Auto-generated constructor stub
		//this.revMapping = lsolution.revMapping;
		for(Task task : nsolution.revMapping.keySet() ) {
			Allocation alloc = nsolution.revMapping.get(task);
			this.addTaskToVM(alloc.getVM(), task, alloc.getStartTime(), false);
		}
	}
	...
	public void updateVM(VM vm){		//��������и�VM�ϵĸ��£�������vm�ľͲ����漰��
...
//		Collections.sort(list);			//�Ѹ�solution���е�task��ʱ��˳�����У�������Ƿ�����������
		for(Allocation alloc : list){
			...
			for(Edge e : task.getOutEdges()){
				...
				//System.out.println("&&&&&childAlloc:" + childAlloc);
				boolean isValid = false;
				//System.out.println("^^^^^^^^^:" +(alloc.getVM() != childAlloc.getVM() 				
