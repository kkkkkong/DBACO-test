...
public class DBACOforTest3 implements Scheduler{
	...
	private Workflow wf;
	private DBAllin2 PDBCAllin2 = new DBAllin2(1.5);
    ...
    private class Ant {
    	...
    	public Ant() {
    		wf.calcPURank(PDBCAllin2.getTheta());
    	}
    	...
    	public Solution constructTheSolution() {
    		...
    		asolution = PDBCAllin2.schedule(wf);
    		return asolution;
    	}
