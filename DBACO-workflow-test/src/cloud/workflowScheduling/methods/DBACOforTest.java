...
public class DBACOforTest implements Scheduler{
	...
	private Workflow wf;
	private DBforTest DB = new DBforTest(1.5);
    ...
    private class Ant {
    	...
    	public Solution constructTheSolution() {
    		...
    		asolution = DB.buildViaTaskList(wf, L, epsilonDeadline);
    		return asolution;
    	}
